    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Halaman Register</h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex position-relative">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="index.php?page=login" class="fw-normal ">Login</a></li>
                    </ol>
                    <a href="index.php?page=register" class="btn btn-danger d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Register</a>
                </div>
            </div>
        </div>
        <!-- /.col-lg-12 -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xlg-9 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form class="form-horizontal form-material" action="action-register.php" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="password" name="re_password" placeholder="Masukkan password" class="form-control p-0 border-0" required>
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="col-sm-12">
                                    <!-- name mengacu pada array key, sedangkan value mengacu pada nilainya.-->
                                    <button class="btn btn-success" name="Submit" value="register">Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
